...
// get all employees
  ...
  $fetch_employees = "select * from employee e join (select ifsc,manager_id from branch where manager_id <> '{$_SESSION['emp_id']}' and manager_id<>0) b on e.emp_id=b.manager_id order by fname,lname";
    ...
    <div class="p-4">
      <div class="welcome">
        <div class="content rounded-3 p-3">
          <h1 align="center" class="fs-3">Managers</h1>
        </div>
      </div>
